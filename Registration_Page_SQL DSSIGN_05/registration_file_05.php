...
$database_name = "Registration_Page_DESIGN_05";
$username_mysql = "root";
$password_mysql = "";
...
if(isset($_POST["processform"])){
    ...
    $sql = "INSERT INTO signup_registrationform05 (
        User_name,
        First_Name,
        Last_Name,
        Address1, 
  ...
  try {
    ...
    if($e->getCode() == 1062){
      ...
      echo"<h2><font color=red>Note: This user_name: $user_name is already in use, kindly go back and try with another unique username</font></h2>";
    }
    else{
...
<script type="text/javascript">
  function validateForm() {
    ...
    var t = document.forms["Form"]["user_name"].value;
...
<!-- <body>
    <div class="wrapper" style="margin-top: 5%; margin-bottom: 5%">
        ...
        <form action="registration_file_05.php" method="post" name="Form" onsubmit="return validateForm()">
